      ...
      <div class="pb-5 border-gray-200 sm:flex sm:items-center sm:justify-between pt-1 pl-12 pr-12 pb-8">
        <div class="mt-3 sm:mt-0 sm:ml-4">
          <form class="text-lg leading-6 font-medium text-gray-900">
            <input id="search" name="search" type="search" autocomplete="search" required class="w-full px-5 py-2 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs border-gray-300 rounded-md" placeholder="search brand">
          </form>
          </div>

          <div class="mt-3 sm:mt-0 sm:ml-4">
          <a href="{{ route('app.brands.create') }}"><button type="button" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
