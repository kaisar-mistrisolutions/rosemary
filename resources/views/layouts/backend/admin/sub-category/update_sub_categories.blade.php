          ...
          <nav class="flex" aria-label="Breadcrumb">
            <ol class="bg-white rounded-md shadow px-3 flex space-x-2 m mt-8 ml-8">
                ...
                <div class="flex items-center">
                    ...
                    <a href="{{ route('app.sub.categories.index', $category->id) }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">All Sub Categories</a>
                </div>
                </li>
                ...
                <div class="flex items-center">
                    ...
                    <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">{{$sub_category->name}}</a>
                </div>
                </li>
            </ol>
          </nav>
          ...
          <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
              ...
              <p class="mt-1 text-sm text-gray-600">
                 Fill the form to update sub category.
              </p>
            </div>
          </div>
