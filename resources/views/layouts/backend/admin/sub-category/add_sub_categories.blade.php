  ...
  <div class="flex flex-col w-0 flex-1 overflow-hidden">
    ...
    <ol class="bg-white rounded-md shadow px-3 flex space-x-2 m mt-8 ml-8">
        ...
        <div class="flex items-center">
            ...
            <a href="{{ route('app.sub.categories.index') }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700" aria-current="page">All Sub-Categories</a>
        </div>
        </li>
    </ol>
    </nav>
            ...
            <div class="grid grid-cols-3 gap-6">
              <div class="col-span-3 sm:col-span-2">
                ...
                <div class="mt-1 flex rounded-md shadow-sm">
                  <input type="text" name="company_website" id="company_website" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-md sm:text-sm border-gray-300" placeholder="sub-category name">
                </div>
              </div>
            </div>
