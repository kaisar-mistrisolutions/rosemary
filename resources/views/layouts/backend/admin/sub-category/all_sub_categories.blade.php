            ...
            <nav class="flex mb-5" aria-label="Breadcrumb">
                <ol class="bg-white rounded-md shadow px-6 flex space-x-4">
                    ...
                    <li class="flex">
                        ...
                        <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Sub Category</a>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <tbody>
          <!-- Odd row -->
            ...
            <tr class="bg-white">
                ...
                <a href="{{ route('app.sub.categories.edit', $sub_category->id)}}" type="button" class="inline-flex items-center justify-center px-2 py-2 border border-transparent font-medium rounded-md text-green-700 bg-green-100 hover:bg-green-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:text-sm">
