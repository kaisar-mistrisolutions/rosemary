            ...
            <nav class="flex mb-5" aria-label="Breadcrumb">
                <ol class="bg-white rounded-md shadow px-6 flex space-x-4">
                    ...
                    <li class="flex">
                        ...
                        <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Category</a>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="w-full flex items-end justify-between p-6 space-x-6">
            <div class="flex-2 truncate">
                ...
                <form action="#" method="get" role="search">
                    <input type="text" name="search" id="search" class="mt-5 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Search Here"/>
                </form>
            </div>
        ...
        <tbody>
          <!-- Odd row -->
            ...
            <tr class="bg-white">
                ...
                <a href="{{ route('app.categories.delete', $category->id) }}" type="button" class="inline-flex items-center justify-center px-2 py-2 border border-transparent font-medium rounded-md text-red-700 bg-red-100 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
