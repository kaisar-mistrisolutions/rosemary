            ...
            <div>
              ...
              <div x-data="{photoName: null, photoPreview: null}" class="col-span-2 ">
                ...
                <div class="mt-2" x-show="! photoPreview" value="{{ $category->image }}" style="display: block;">
                    <img class="max-w-lg flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md" src="{{Storage::url($category->image)}}" class="rounded-full h-20 w-20 object-cover">
                </div>
