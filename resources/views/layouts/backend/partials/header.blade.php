<div class="flex-1 px-4 flex justify-between">
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="px-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
              <a class="dropdown-item block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2" href="locale/en">
             {{ __('English') }}
            </a>
          </div>
            ...
            <div class="px-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
              ...
              <a class="dropdown-item block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2" href="locale/ko"
              >
             {{ __('Korean') }}
            </a>
            </div>
          ...
          <button @click="open = !open" type="button" class="max-w-xs bg-white flex items-center text-sm  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
            ...
            <div class="widget-content-left  ml-3 header-user-info">
                ...
                @lang('dashboard.role'): {{ Auth::user()->role->name }}
                </div>
            </div>
